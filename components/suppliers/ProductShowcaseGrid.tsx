      ...
      {displayProducts.slice(0, 12).map((product) => {
        ...
        return (
          <Card
            key={product.id}
            className={cn(
              "group relative overflow-hidden hover:shadow-lg transition-all duration-300 bg-slate-800/50",
          ...
          >
            ...
            <div className="p-4">
              ...
              {isPlaceholder && isOwner && (
                <Link href="/supplier/products/manage">
                  <p className="text-sm text-slate-400 mt-2 hover:text-cyan-500 cursor-pointer">
