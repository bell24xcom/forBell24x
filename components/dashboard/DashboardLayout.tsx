...
import {
  LayoutDashboard, PlusCircle, FileText, MessageSquare, Handshake,
...
const buyerNavItems: NavItem[] = [
  ...
  { icon: Handshake, label: 'Active Deals', href: '/dashboard/deals' },
...
const supplierNavItems: NavItem[] = [
  ...
  { icon: Handshake, label: 'Active Deals', href: '/supplier/deals' },
