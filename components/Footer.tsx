        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href="https://instagram.com/bell24h" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-pink-400 transition-colors" aria-label="Instagram">
              ...
              <a href="https://youtube.com/@bell24h" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-red-400 transition-colors" aria-label="YouTube">
