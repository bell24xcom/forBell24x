...
export async function GET(request: NextRequest) {
  ...
  const html = `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto">
        ...
        <div style="padding:32px;background:#f8fafc;border:1px solid #e5e7eb;border-radius:0 0 8px 8px">
          ...
          <p style="color:#6b7280;line-height:1.6">SMTP is correctly configured. Transactional emails from Bell24h will be delivered.</p>
          <table style="width:100%;border-collapse:collapse;margin-top:16px">
            <tr><td style="color:#9ca3af;padding:6px 0;font-size:14px">Service</td><td style="color:#1f2937;font-size:14px">Nodemailer SMTP</td></tr>
  ...
  const result = await sendEmail(to, 'Bell24h — Email Delivery Test', html);
