...
const Page = () => {
  ...
  const intro = `Discover leading ${category.toLowerCase()} suppliers and manufacturers in ${city}, a significant industrial and commercial hub in Gujarat, India. Ahmedabad is a key center for various industries, including a strong presence in ${category.toLowerCase()} solutions that serve diverse sectors like pharmaceuticals, textiles, food processing, and e-commerce. Bell24h connects you with reliable ${category.toLowerCase()} providers known for innovation, quality, and competitive pricing, supporting businesses across India and for global export markets.`;
  const productTypes = [
    "Corrugated Boxes",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-slate-900/50 border border-slate-700 rounded-xl p-5">
                ...
                <p className="text-slate-300 leading-relaxed text-sm">
                  Quickly articulate your specific needs for {category} products via voice. Our AI transcribes and analyzes your request, ensuring clarity and speed, perfect for urgent requirements in busy markets like Ahmedabad.
                </p>
              </div>
              <div className="bg-slate-900/50 border border-slate-700 rounded-xl p-5">
                <h3 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
