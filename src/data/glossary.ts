...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'On VyaparSethu, all completed Deals auto-generate a GST-compliant invoice with the correct HSN code, CGST/SGST breakdown, and both parties\' GSTINs — reducing errors and ensuring buyer ITC eligibility. Calculate tax breakdowns and invoice totals instantly with our free [GST Calculator](/tools/gst-calculator), or check vendor credentials in our [Supplier Verification Guide](/how-verification-works).',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'VyaparSethu recommends using Protected Payment for first-time supplier relationships. To eliminate default risk, learn how [Protected Payments](/how-payment-works) protect cash flow until delivery is verified before offering unsecured credit.',
    ],
