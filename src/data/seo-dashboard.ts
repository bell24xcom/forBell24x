...
export const INDEXING_STATUS: IndexingStatus[] = [
  ...
  { path: '/categories/textiles-yarn-fabrics', label: 'Textiles, Yarn & Fabrics', status: 'requested', lastCrawl: null, notes: 'Main textile hub; request indexing in GSC and keep in sitemap.' },
  { path: '/categories/upholstery-fabric-swatch-books', label: 'Upholstery Fabric Swatch Books', status: 'requested', lastCrawl: null, notes: 'New textile child category; export and interior buyers.' },
  { path: '/categories/curtain-fabric-swatch-books', label: 'Curtain Fabric Swatch Books', status: 'requested', lastCrawl: null, notes: 'New textile child category; curtain and drapery sampling.' },
  { path: '/categories/fabric-sample-cards', label: 'Fabric Sample Cards', status: 'requested', lastCrawl: null, notes: 'Sample-card landing page; use Search Console URL inspection.' },
  { path: '/categories/sample-book-fasteners-binding-hardware', label: 'Sample Book Fasteners & Binding Hardware', status: 'requested', lastCrawl: null, notes: 'Hardware landing page for sample-book makers.' },
...
export const SEO_CHECKLIST: SeoChecklistItem[] = [
  ...
  { id: 'crunchbase', task: 'Crunchbase organization listing', owner: 'manual', status: 'pending', priority: 'high', notes: '/admin/seo/backlinks → copy-paste guide' },
  { id: 'g2', task: 'G2 product profile', owner: 'manual', status: 'pending', priority: 'high', notes: '/admin/directories/submit?guide=g2' },
  { id: 'startup-india', task: 'Startup India DPIIT registration', owner: 'manual', status: 'pending', priority: 'high', notes: '/admin/directories/submit?guide=startupindia' },
