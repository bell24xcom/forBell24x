  ...
  return (
    <section className="bg-blue-600 py-24 md:py-32">
      <div className="container mx-auto px-4 max-w-7xl text-center">
        ...
        <p className="text-xl md:text-2xl text-white/90 mb-16 max-w-4xl mx-auto">Be among the first businesses using VyaparSethu for faster, smarter B2B transactions</p>
