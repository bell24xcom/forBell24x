    ...
    <UserDashboardLayout>
      <div className="w-full max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-slate-300 mt-1">Complete your supplier profile registration</p>
        </div>

        {/* Progress Steps */}
        <div className="bg-slate-800/50 rounded-xl shadow-sm border border-slate-700 p-6 mb-6">
              ...
              return (
                <React.Fragment key={step.id}>
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className={`text-sm font-medium ${isActive ? 'text-[#0070f3]' : 'text-slate-400'}`}>
                        {step.title}
                      </p>
                    </div>
                  </div>
        ...
        <form onSubmit={handleSubmit} className="bg-slate-800/50 rounded-xl shadow-sm border border-slate-700 p-6 space-y-6">
          ...
          <div className="flex justify-between pt-4 border-t border-slate-700">
            <button
              ...
              className="px-6 py-2 border border-slate-700 bg-slate-800 text-white text-slate-300 rounded-lg hover:bg-slate-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Previous
            </button>
