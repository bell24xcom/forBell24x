          ...
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full bg-neutral-200 text-neutral-800 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
              >
                Go Back
              </button>
            </div>
